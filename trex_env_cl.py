...
# ------------------------
# Entorno Gymnasium con Curriculum Learning
# ------------------------
class DinoEnv(gym.Env):
    ...
    def step(self, action):
        ...
        # Generar obstáculos según dificultad
        if len(self.obstacles) == 0:
            if self.difficulty == 1:
                choice = random.randint(0, 1)  # solo cactus
            else:
                choice = random.randint(0, 2)  # cactus o pájaro
            ...
            if choice == 0:
                ...
                if self.difficulty == 3:
                    # altura aleatoria para pájaros
                    bird.rect.y = random.randint(200, 300)
