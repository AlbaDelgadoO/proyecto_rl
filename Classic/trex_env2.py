...
class DinoEnv(gym.Env):
    ...
    def step(self, action):
            ...
            # Recompensa base por sobrevivir un frame más
            reward = 1 
            done = False
            ...
            # HEMOS ELIMINADO LOS "if action == 1: reward += 1"
            # Ahora el agente no recibe puntos extra por spamear saltos.
            # Solo recibe puntos por mantenerse vivo.
            
            # Opcional: Pequeña penalización por saltar/agacharse innecesariamente
            # para animarle a correr (acción 0) si no hay peligro.
